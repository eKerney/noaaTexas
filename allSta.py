...
def addMonths():
    ...
    # experimental dataframe download button
    #csv = noaaMonthly.to_csv().encode('utf-8')
    #st.sidebar.download_button("Press to Download Raw Data", 
    #    csv, (f'{station}-{st.session_state.month}-{year}.csv'),"text/csv",key='download-csv')
    #st.write(noaaMonthly)
